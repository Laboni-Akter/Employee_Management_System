...
Hello There, It is a simple university project of web development course. I have made a simple UI and basic SQL commands to make this project.
...
3. Goto phpmyadmin and create a database named **emp** and then import the file named **emp.sql**
