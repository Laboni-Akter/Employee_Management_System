...
<body>
	...
	<header>
		<nav>
			...
			<ul id="navli">
				...
				<li><a class="homeblack" href="emplogout.php">Log Out</a></li>
			</ul>
		</nav>
	</header>
	...
	<div>
		<!-- <h2>Welcome <?php echo "$empName"; ?> </h2> -->
		    	...
		    	<h2 style="font-family: 'Montserrat', sans-serif; color: #ffff; font-size: 25px; text-align: center;">Empolyee Leaderboard </h2>
    	...
    	<h2 style="font-family: 'Montserrat', sans-serif; color:#ffff; font-size: 25px; text-align: center;">Due Projects</h2>
		...
		<h2 style="font-family: 'Montserrat', sans-serif; color:#ffff; font-size: 25px; text-align: center;">Salary Status</h2>
		...
		<h2 style="font-family: 'Montserrat', sans-serif; color:#ffff; font-size: 25px; text-align: center;">Leave Satus</h2>
